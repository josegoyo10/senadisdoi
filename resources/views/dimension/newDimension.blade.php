...
<ol class="breadcrumb">
  ...
  <li class="active">Nueva dimensión</li>
</ol>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="box box-primary direct-chat direct-chat-primary">
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              {{ Form::open(array('route' => array('dimension.store'), 'method' => 'POST','id'=>'frm', 'data-toggle'=>'validator', 'role'=>'form')) }}
                              ...
                              <div class="form-group">
                                 ...
                                 <a href="/formulario-encuesta/{{$id_encuesta}}" class="btn btn-primary">Salir</a>
                                 {{ Form::close() }}
                              </div>
                           </div>
                        </div>
