            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="padding: 25px 0; text-align: center;">
                        <a style=" font-weight: bold; color: #2F3133; text-decoration: none; text-shadow: 0 1px 0 white;" href="#" target="_blank">
                            SENADIS
                        </a>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td style=" padding: 35px;">
                                    ...
                                    <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                        Para reiniciar su contraseña presione el botón, luego coloque su correo en el formulario.
                                    </p>
                                                ...
                                                <a href="{{url('password/reset/')}}"
                                                   ...
                                                   style=" display: block; display: inline-block; width: 200px; min-height: 20px; padding: 10px;
                                                     ...
                                                     text-align: center; text-decoration: none; -webkit-text-size-adjust: none; background-color: #3869D4;"
                                                                                       class="button"
                                                   target="_blank">
                                                    {{ trans('traduction.reset_password') }}
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td style=" color: #AEAEAE; padding: 35px; text-align: center;">
                                    <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                        &copy; 2017
                                        <a style="color: #3869D4;" href="{{ url('/') }}" target="_blank">SENADIS</a>.
