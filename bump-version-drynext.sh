...
#########################################################################
#
# FIX: Calculo de versiones > 99
#
# USO: increment_version [-l] [-t] <version> [<position>] [<leftmost>]
#
# Ejemplos:
...
increment_version() {
 ...
 VERSION=`head -1 /home/debian/IMDIS/version.txt`
 NEW=`increment_version $VERSION 2`
 sed -i "1i ${NEW// /.}" /home/debian/IMDIS/version.txt
 echo $NEW
